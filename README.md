...
This package is designed to work with **MUI v7** and **React 18+** (including React 19).
...
For React 19 applications, you can use the compatibility layer:

```tsx
import { CssBaseline, ThemeProvider } from '@mui/material'
import { createCompatibleTheme } from 'mui-create-material-you-theme'

const materialYouLight = createCompatibleTheme('light')
