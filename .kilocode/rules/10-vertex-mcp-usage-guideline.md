...
related_context = [
    ...
    ".kilocode/rules/08-logging-procedure-simplified.md",
...
- **Subdirectory Structure:** Organize files by the _type_ of tool used:
...
- **File Naming Convention:** Files **MUST** be named using the format `[YYYYMMDDHHMMSS]-[sanitized_topic_or_query].md`.
  ...
  - _Example:_ `.ruru/docs/vertex/guidelines/20250426182500-react_ts_node_guidelines.md`
