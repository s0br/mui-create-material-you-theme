...
related_context = [
    ".kilocode/rules/01-standard-toml-md-format.md",
    ".kilocode/rules/12-logging-procedure-rule.md",
    ".ruru/tasks/",
...
7.  **Delegate via `new_task`:**
    ...
    - Provide any _essential_ immediate context if needed, but the primary instructions reside within the task file.
