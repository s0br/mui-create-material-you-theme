...
5.  **Consult Workspace Standard:** Refer to the workspace logging rule (`.kilocode/rules/08-logging-procedure-simplified.md`) and its associated KB (`.ruru/modes/roo-commander/kb/12-logging-procedures.md`) for detailed tool usage guidance (`apply_diff`, `insert_content`, etc.).