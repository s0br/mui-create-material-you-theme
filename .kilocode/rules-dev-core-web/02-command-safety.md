...
related_context = [
    ".kilocode/rules/05-os-aware-commands.md", # Workspace OS awareness rule
    ".kilocode/rules-roo-commander/07-safety-protocols-rule.md" # General safety concept
    ]
...
3.  **OS Awareness:** Generate OS-aware commands based on `environment_details.os` (See Rule `.kilocode/rules/05-os-aware-commands.md`).
