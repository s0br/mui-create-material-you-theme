 ...
 */
export declare const createCompatibleTheme: (mode: PaletteMode, exportedScheme?: MaterialYouSchemeExported, themeOptions?: ThemeOptions, missingColors?: MaterialYouMissingColors) => import('@mui/material').Theme;
